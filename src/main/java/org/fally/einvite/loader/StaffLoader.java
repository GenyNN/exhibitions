package org.fally.einvite.loader;
...
public class StaffLoader {
    ...
    public void evaluateSecurity() {
        if (staffRepository.count() == 0) {
            ...
            LOGGER.warn("Please be sure to create new accounts before using Einvite in a production setting!");
        } else {
            ...
            if (admin != null && bCryptPasswordEncoder.matches(DEFAULT_PASS, admin.getPassword())) {
                ...
                LOGGER.warn("Please be sure to delete it or change the password before using Einvite in a production setting!");
            } else {
